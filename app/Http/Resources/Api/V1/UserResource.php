...
class UserResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'scheduled_permanent_deletion_at' => $this->scheduled_permanent_deletion_at,
            'deletion_cancel_requested_at' => $this->deletion_cancel_requested_at,
            'permanently_deleted_at' => $this->permanently_deleted_at,
            'is_pending_deletion' => $this->isPendingDeletion(),
            'has_deletion_cancel_request' => $this->hasDeletionCancelRequest(),
