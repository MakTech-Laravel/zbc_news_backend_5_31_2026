                    ...
                    <tr>
                        <td class="content-pad" style="padding:28px 24px;">
                                ...
                                <tr>
                                    <td style="padding:24px 20px;">
                                        ...
                                        @if(!empty($replyExcerpt))
                                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" bgcolor="#f8fafc" style="width:100%;background-color:#f8fafc;border:1px solid #e5e7eb;border-radius:12px;margin:0 0 16px;">
                                                <tr>
                            ...
                            <p style="margin:24px 0 0;text-align:center;">
                                <a href="{{ $articleUrl }}" style="display:inline-block;padding:12px 24px;background-color:#51a2ff;color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;border-radius:8px;">
                                    View article
                                </a>
                            </p>
                        </td>
